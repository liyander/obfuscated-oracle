...
RUN echo '#!/bin/bash' > /home/ctfuser/hint.txt && \
    ...
    echo '  strings oracle | grep FLAG_ENCODED  - Find the encoded flag' >> /home/ctfuser/hint.txt && \
    echo '  echo "<base64>" | base64 -d  - Decode Base64' >> /home/ctfuser/hint.txt && \
    echo '' >> /home/ctfuser/hint.txt && \
    echo 'One-liner:' >> /home/ctfuser/hint.txt && \
    echo '  strings oracle | grep FLAG_ENCODED | sed "s/.*BASE64_\(.*\)_END_FLAG.*/\1/" | base64 -d' >> /home/ctfuser/hint.txt && \
